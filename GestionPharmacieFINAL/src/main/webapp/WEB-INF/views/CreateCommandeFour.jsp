...
<head>
    ...
    <title>Ajouter une commande fournisseur</title>
    <style>
        body {
...
<form action="/newCommandeFour" method="POST" >

    <label for="id">id de la pharmacie :</label>
    <input type="text" id="id" name="id"><br>

    <label for="dateCommande">dateCommande :</label>
    <input type="date" id="dateCommande" name="dateCommande"><br>
