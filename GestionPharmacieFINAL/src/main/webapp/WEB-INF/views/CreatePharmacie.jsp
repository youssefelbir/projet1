...
<form action="/newPharmacie" method="POST" >

    <label for="nomPh">Nom de la pharmacie :</label>
    <input type="text" id="nomPh" name="nomPh"><br>
    ...
    <input type="email" id="mailPh" name="mailPh"><br>

    <label for="telPh">Numero de telephone :</label>
    <input type="tel" id="telPh" name="telPh" pattern="[0-9]{10}" placeholder="Format: 0123456789" maxlength="10"><br>

    <label for="garde">En garde ?</label>
    <input type="checkbox" id="garde" name="garde"><br>
