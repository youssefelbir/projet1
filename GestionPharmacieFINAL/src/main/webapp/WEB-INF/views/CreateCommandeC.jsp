...
<head>
    ...
    <title>CommandeC Creation</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-container">
                    <form action="saveCommandeC" method="post">
                        <div class="mb-3">
                            <label for="adresseLiv" class="form-label">adresseLiv:</label>
                            <input type="text" class="form-control" id="adresseLiv" name="adresseLiv">
                        </div>
                        <div class="mb-3">
                            <label for="Livreur" class="form-label">livreur:</label>
                            <input type="number" class="form-control" id="Livreur" name="Livreur">
                        </div>
                        <div class="mb-3">
